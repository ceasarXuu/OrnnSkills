...
- [ ] P1 `src/dashboard/ui.ts`
  ...
  4. `[ ]` 抽出 `web/render/*`（已完成 `render/skill-card`、`render/trace-bars`、`render/state-badge`、`render/metric-rows`）
...
当前进行中：
- [ ] `src/dashboard/ui.ts` 第 4 步：抽出 `web/render/*`（下一项：`render/cost-breakdown`）
